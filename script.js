...
function initializeTypingEffect() {
    ...
    const texts = ['DevOps Enthusiast', 'Cloud Explorer',];
    let textIndex = 0;
    let charIndex = 0;
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactFormElement) {
        contactFormElement.addEventListener('submit', function(e) {
            ...
            const emailBody = `Hello Mairazul,
...
${name}`;
            ...
            const gmailUrl = `https://mail.google.com/mail/?view=cm&fs=1&to=mairazulkhan@gmail.com&su=${encodeURIComponent(subject)}&body=${encodeURIComponent(emailBody)}`;
